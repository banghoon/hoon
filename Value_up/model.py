...
model = Sequential()
model.add(LSTM(16, batch_input_shape=(1, look_back, 1), return_sequences=True, stateful=True))
model.add(Dropout(0.3))
model.add(LSTM(32, batch_input_shape=(1, look_back, 1), return_sequences=True, stateful=True))
model.add(Dropout(0.3))
model.add(LSTM(32, batch_input_shape=(1, look_back, 1), return_sequences=True, stateful=True))
model.add(Dropout(0.3))
model.add(LSTM(64, batch_input_shape=(1, look_back, 1), stateful=True))
model.add(Dropout(0.3))
model.add(Dense(1))
...
for i in range(50):
    ...
    model.save(f'D://value_up_model//LSTM//LSTM_{i+1}.h5')
    model.reset_states()
